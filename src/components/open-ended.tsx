...
const OpenEnded = ({ game }: Props) => {
  ...
  const { mutate: checkAnswer, isLoading: isChecking } = useMutation({mutationFn: async () => {
    let filledAnswer = blankAnswer;
    const inputElements = document.querySelectorAll<HTMLInputElement>("#user-blank-input"); // Specify the type as HTMLInputElement
